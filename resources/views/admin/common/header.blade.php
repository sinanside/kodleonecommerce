                    ...
                    <a href="{{ URL::to("admin/vieworder")}}/{{ $unseenOrder->orders_id}}">
                      <div class="pull-left">
                         ...
                         @if(!empty($unseenOrder->customers_picture))
                            ...
                            @else
                            <img src="{{asset('').'/images/default_images/user.png' }}" class="img-circle" alt="{{ $unseenOrder->customers_name }} Image">
                         @endif
                    ...
                    <a href="{{ URL::to("admin/editcustomers")}}/{{ $newCustomer->customers_id}}">
                      <div class="pull-left">
                         @if(!empty($newCustomer->customers_picture))
                            ...
                            @else
                            <img src="{{asset('').'/images/default_images/user.png' }}" class="img-circle" alt="{{ $newCustomer->customers_firstname }} Image">
                         @endif
                      </div>
                      <h4>
