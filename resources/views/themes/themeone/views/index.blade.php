                       ...
                       <div class="thumb"> <img class="img-fluid" src="{{asset($top_seller->products_image)}}" alt="{{$top_seller->products_name}}"></div>
                        ...
                        <div class="price text-center">
                        	@if(!empty($top_seller->discount_price))
                          	...
                          	<span> {{$top_seller->products_price+0}} {{$web_setting[19]->value}}</span>
                          	@else
                          		{{$top_seller->products_price+0}} {{$web_setting[19]->value}}
                ...
                <div class="product">
                  <article>
                    ...
                    <div class="price text-center">
                    	...
                    	<span>{{$special->products_price+0}} {{$web_setting[19]->value}}</span>
                    </div>
