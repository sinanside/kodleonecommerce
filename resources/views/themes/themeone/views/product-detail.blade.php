                                ...
                                <div class="product-summary">
                                    ...
                                    <div class="product-info">
                                     ...
                                     <div class="product-price">
                                        ...
                                        <span class="discount">
                                                    {{$result['detail']['product_data'][0]->flash_price+0}} {{$web_setting[19]->value}}
                                         </span>
                                        @elseif(!empty($result['detail']['product_data'][0]->discount_price))
                                            <span class="discount">
                                                    {{$result['detail']['product_data'][0]->discount_price+0}} {{$web_setting[19]->value}}
                                            </span>
                                        @endif		
                                        ...
                                        <span class="price @if(!empty($result['detail']['product_data'][0]->discount_price) or !empty($result['detail']['product_data'][0]->flash_price)) line-through @else change_price @endif" >
                                            {{$result['detail']['product_data'][0]->products_price+0}} {{$web_setting[19]->value}}
                                        </span>                                    
                                    ...
                                    <form name="attributes" id="add-Product-form" method="post" >
                                        ...
                                        @endphp
                                            ...
                                            <div class="price-box">
                                                ...
                                                {{$product_price}} {{$web_setting[19]->value}}
                                                </span>				
                                            </div>  
                                    ...
                                    <article>
                                        ...
                                        <div class="price text-center">
                                            @if(!empty($products->discount_price))
                                                ...
                                                <span>{{$products->products_price+0}} {{$web_setting[19]->value}}</span>
                                            @else
