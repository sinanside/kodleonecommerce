                        ...
                        <article>
                            ...
                            <div class="price">
                                @if(!empty($products->discount_price))
                                    ...
                                    {{$products->discount_price+0}} {{$web_setting[19]->value}}<span>{{$products->products_price+0}} {{$web_setting[19]->value}}</span>
                                @else
                                    
                                    {{$products->products_price+0}} {{$web_setting[19]->value}}
                              ...
                              <article>
                                <div class="thumb"> <img class="img-fluid" src="{{asset($products->products_image)}}" alt="{{$products->products_name}}"> </div>
                                    ...
                                    <div class="price text-center"> @if(!empty($products->discount_price))                                  
                                        {{$products->discount_price+0}} {{$web_setting[19]->value}}<span>{{$products->products_price+0}} {{$web_setting[19]->value}}</span> @else
                                        {{$products->products_price+0}} {{$web_setting[19]->value}}
                                        @endif
                                    </div>
                    ...
                    <div class="products products-5x">
                        ...
                        <div class="product">
                          <article>
                            ...
                            {{$special->discount_price+0}} {{$web_setting[19]->value}}<span>{{$special->products_price+0}} {{$web_setting[19]->value}}</span></div>
                            <div class="product-hover">
                                <div class="icons">
                                    <div class="icon-liked">
