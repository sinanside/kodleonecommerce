                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <form name="signup" enctype="multipart/form-data" class="form-validate" action="{{ URL::to('/checkout_shipping_address')}}" method="post">
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control field-validate" id="firstname" name="firstname" value="@if(count(get_object_vars(session('shipping_address')))>0){{session('shipping_address')->firstname}}@endif">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control field-validate" id="lastname" name="lastname" value="@if(count(get_object_vars(session('shipping_address')))>0){{session('shipping_address')->lastname}}@endif">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control field-validate" id="company" name="company" value="@if(count(get_object_vars(session('shipping_address')))>0) {{session('shipping_address')->company}}@endif">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control field-validate" id="street" name="street" value="@if(count(get_object_vars(session('shipping_address')))>0){{session('shipping_address')->street}}@endif">
                                  ...
                                  <select class="form-control field-validate" id="entry_country_id" onChange="getZones();" name="countries_id">
                                      ...
                                      @if(count($result['countries'])>0)
                                        @foreach($result['countries'] as $countries)
                                            <option value="{{$countries->countries_id}}" @if(count(get_object_vars(session('shipping_address')))>0) @if(session('shipping_address')->countries_id == $countries->countries_id) selected @endif @endif >{{$countries->countries_name}}</option>
                                        @endforeach
                                      @endif
                                  </select>
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <select class="form-control field-validate" id="entry_zone_id" name="zone_id">
                                      ...
                                      @endif
                                       ...
                                       <option value="Other" @if(count(get_object_vars(session('shipping_address')))>0) @if(session('shipping_address')->zone_id == 'Other') selected @endif @endif>@lang('website.Other')</option>
                                </select>
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control field-validate" id="city" name="city" value="@if(count(get_object_vars(session('shipping_address')))>0){{session('shipping_address')->city}}@endif">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="postcode" name="postcode" value="@if(count(get_object_vars(session('shipping_address')))>0){{session('shipping_address')->postcode}}@endif">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="delivery_phone" name="delivery_phone" value="@if(count(get_object_vars(session('shipping_address')))>0){{session('shipping_address')->delivery_phone}}@endif">
                      ...
                      <div class="tab-pane fade @if(session('step') == 1) show active @endif" id="pills-billing" role="tabpanel" aria-labelledby="billing-tab">
                        ...
                        <div class="form-row">
                          <div class="form-group col-md-6">
                            <label for="firstName">@lang('website.First Name')</label>
                            <input type="text" class="form-control same_address" @if(count(get_object_vars(session('shipping_address')))>0) @if(session('billing_address')->same_billing_address==1) readonly @endif @else readonly @endif  id="billing_firstname" name="billing_firstname" value="@if(count(get_object_vars(session('shipping_address')))>0){{session('billing_address')->billing_firstname}}@endif">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your first name')</span>  
                          </div>
                          <div class="form-group col-md-6">
                            <label for="lastName">@lang('website.Last Name')</label>
                            <input type="text" class="form-control same_address" @if(count(get_object_vars(session('shipping_address')))>0) @if(session('billing_address')->same_billing_address==1) readonly @endif @else readonly @endif  id="billing_lastname" name="billing_lastname" value="@if(count(get_object_vars(session('shipping_address')))>0){{session('billing_address')->billing_lastname}}@endif">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your last name')</span> 
                          </div>
                          <div class="form-group col-md-6">
                            <label for="firstName">@lang('website.Company')</label>
                            <input type="text" class="form-control same_address" @if(count(get_object_vars(session('shipping_address')))>0) @if(session('billing_address')->same_billing_address==1) readonly @endif @else readonly @endif  id="billing_company" name="billing_company" value="@if(count(get_object_vars(session('shipping_address')))>0){{session('billing_address')->billing_company}}@endif">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your company name')</span> 
                          </div>
                          <div class="form-group col-md-6">
                            <label for="firstName">@lang('website.Address')</label>
                            <input type="text" class="form-control same_address" @if(count(get_object_vars(session('shipping_address')))>0) @if(session('billing_address')->same_billing_address==1) readonly @endif @else readonly @endif  id="billing_street" name="billing_street" value="@if(count(get_object_vars(session('shipping_address')))>0){{session('billing_address')->billing_street}}@endif">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your address')</span>
                          </div>
                          <div class="form-group col-md-6">
                            <label for="lastName">@lang('website.Country')</label>
                              <select class="form-control same_address_select" id="billing_countries_id"  onChange="getBillingZones();" name="billing_countries_id" @if(count(get_object_vars(session('shipping_address')))>0) @if(session('billing_address')->same_billing_address==1) disabled @endif @else disabled @endif  >
                                  <option value=""  >@lang('website.Select Country')</option>
                                  @if(count($result['countries'])>0)
                                    @foreach($result['countries'] as $countries)
                                        <option value="{{$countries->countries_id}}" @if(count(get_object_vars(session('shipping_address')))>0) @if(session('billing_address')->billing_countries_id == $countries->countries_id) selected @endif @endif >{{$countries->countries_name}}</option>
                                    @endforeach
                                  @endif
                              </select>
                              <span class="help-block error-content" hidden>@lang('website.Please select your country')</span> 
                          ...
                          <div class="form-group col-md-6">
                            <label for="firstName">@lang('website.State')</label>
                            <select class="form-control same_address_select" id="billing_zone_id" name="billing_zone_id" @if(count(get_object_vars(session('shipping_address')))>0) @if(session('billing_address')->same_billing_address==1) disabled @endif @else disabled @endif  >
                                  <option value="" >@lang('website.Select State')</option>
                                  @if(count($result['zones'])>0)
                                    @foreach($result['zones'] as $key=>$zones)
                                        <option value="{{$zones->zone_id}}" @if(count(get_object_vars(session('shipping_address')))>0) @if(session('billing_address')->billing_zone_id == $zones->zone_id) selected @endif @endif >{{$zones->zone_name}}</option>
                                    @endforeach                        
                                  @endif
                                    <option value="Other" @if(count(get_object_vars(session('shipping_address')))>0) @if(session('billing_address')->billing_zone_id == 'Other') selected @endif @endif>@lang('website.Other')</option>
                              </select>
                              <span class="help-block error-content" hidden>@lang('website.Please select your state')</span> 
                          </div>
                          <div class="form-group col-md-6">
                            <label for="lastName">@lang('website.City')</label>
                            <input type="text" class="form-control same_address" @if(count(get_object_vars(session('shipping_address')))>0) @if(session('billing_address')->same_billing_address==1) readonly @endif @else readonly @endif  id="billing_city" name="billing_city" value="@if(count(get_object_vars(session('shipping_address')))>0){{session('billing_address')->billing_city}}@endif">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your city')</span>
                          </div>
                          <div class="form-group col-md-6">
                            <label for="lastName">@lang('website.Zip/Postal Code')</label>
                            <input type="text" class="form-control same_address"  @if(count(get_object_vars(session('shipping_address')))>0) @if(session('billing_address')->same_billing_address==1) readonly @endif @else readonly @endif  id="billing_zip" name="billing_zip" value="@if(count(get_object_vars(session('shipping_address')))>0){{session('billing_address')->billing_zip}}@endif">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your Zip/Postal Code')</span> 
                          </div>	
                          	
                          <div class="form-group col-md-6">
                            <label for="lastName">@lang('website.Phone Number')</label>
                            <input type="text" class="form-control same_address" @if(count(get_object_vars(session('shipping_address')))>0) @if(session('billing_address')->same_billing_address==1) readonly @endif @else readonly @endif  id="billing_phone" name="billing_phone" value="@if(count(get_object_vars(session('shipping_address')))>0){{session('billing_address')->billing_phone}}@endif">
                            <span class="help-block error-content" hidden>@lang('website.Please enter your valid phone number')</span> 
                          </div>	  
                        </div>			
                        <div class="form-group">
                            <div class="form-check">
                              <label class="form-check-label">
                                  <input  class="form-check-input" id="same_billing_address" value="1" type="checkbox" name="same_billing_address" @if(count(get_object_vars(session('shipping_address')))>0) @if(session('billing_address')->same_billing_address==1) checked @endif @else checked  @endif > @lang('website.Same shipping and billing address')
                              </label>
                            </div>
                        </div>
                        <div class="button"><button type="submit" class="btn btn-dark"> @lang('website.Continue')</button></div>
                                        ...
                                        <ul class="list">                              
                                            @foreach($shipping_methods['services'] as $services)
                                             <?php
                                                ...
                                                ?>
                                                <li>
                                                <input class="shipping_data" id="{{$method_name}}" type="radio" name="shipping_method" value="{{$services['shipping_method']}}" shipping_price="{{$services['rate']}}"  method_name="{{$method_name}}" @if(!empty(session('shipping_detail')) and count(get_object_vars(session('shipping_address'))) > 0)
                ...
                <div class="tab-pane fade @if(session('step') == 3) show active @endif" id="pills-order" role="tabpanel" aria-labelledby="order-tab"> 
                    ...
                    <div class="order-review">
                        ...
                        <form method='POST' id="update_cart_form" action='{{ URL::to('/place_order')}}' >
                            ...
                            <?php			
                                if(!empty(session('shipping_detail')) and count(get_object_vars(session('shipping_address')))>0){
                                ...
                                <table class="table">
                                	<thead>
                                  	...
                                  	<tbody>
                                        <tr>
                                            <th><span>@lang('website.SubTotal')</span></th>
                                            <td align="right" id="subtotal">{{$price+0}} {{$web_setting[19]->value}}</td>
                                        </tr>
                                        <tr>
                                            <th><span>@lang('website.Tax')</span></th>
                                            <td align="right">{{$tax_rate}} {{$web_setting[19]->value}}</td>
                                        </tr>
                                        <tr>
                                            <th>
                                            	<span>@lang('website.Shipping Cost')</br><small>{{$shipping_name}}</small>  @if(!empty($web_setting[82]->value))</br><small>@lang('website.Avail free shpping on') {{$web_setting[82]->value}} {{$web_setting[19]->value}}.</small>@endif</span></th>
                                            <td align="right">{{$shipping_price}} {{$web_setting[19]->value}}</td>
                                        </tr>
                                        <tr>
                                            <th><span>@lang('website.Discount(Coupon)')</span></th>
                                            <td align="right" id="discount">{{number_format((float)session('coupon_discount'), 2, '.', '')+0}} {{$web_setting[19]->value}}</td>
                                        </tr>
                                        <tr>
                                            <th class="last"><span>@lang('website.Total')</span></th>
                                            <td class="last" align="right" id="total_price">{{number_format((float)$total_price+0, 2, '.', '')+0}} {{$web_setting[19]->value}}</td>
                                        </tr>
                                	</tbody>
                                </table>
                            </div>
