...
class AdminProductsController extends Controller
{
	...
	public function addnewproduct(Request $request){
		...
		if($request->hasFile('products_image') and in_array($request->products_image->extension(), $extensions)){
			...
			$uploadImage = 'images/product_images/'.$fileName;
		}else{
			$uploadImage = '';
		}	
		...
		foreach($languages as $languages_data){
			...
			if($request->hasFile($products_left_banner) and in_array($request->$products_left_banner->extension(), $extensions)){
				...
				$image->move('products_banners/', $fileName);
				$leftBanner = 'public/images/products_banners/'.$fileName;
			}else{
				$leftBanner = '';
			}	
			...
			if($request->hasFile($products_right_banner) and in_array($request->$products_right_banner->extension(), $extensions)){
				...
				$image->move('images/products_banners/', $fileName);
				$rightBanner = 'images/products_banners/'.$fileName;
			}else{
				$rightBanner = '';
			}	
	...
	public function updateproduct(Request $request){
		...
		foreach($languages as $languages_data){			
			...
			if($request->hasFile($products_left_banner) and in_array($request->$products_left_banner->extension(), $extensions)){
				...
				$leftBanner = 'images/products_banners/'.$fileName;
